...
const (
	...
	// The merged table measures 42 rows. This branch's CantBlockUnless
	// closure (6e77a1e8) and main's First-Strike Damage closure (acc7878d)
	// join the main-side layer-4 (63c07260), mulligan-redraw (7c4182ff),
	// non<X> (d56e404f), NameCard (78d3b764), battle-protector (f76f59fd),
