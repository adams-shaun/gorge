...
const (
	...
	// 616.1 closures), this branch's (blockprop1) deletion (fix 6e77a1e8),
	// and main's own mulligan-redraw deferral (fix 7c4182ff), which deletes
	// the "mulligan declaration's REDRAW resolves immediately" row.
