...
const (
	...
	// The merged table currently measures 35 rows after the branch's
	// CanBeTargetedByTriggeredSpellAbility closure and main's intervening
	// closures. Keep this ratchet aligned with the merged AGENTS.md table.
