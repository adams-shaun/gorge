...
const (
	...
	// 74 = the merged table's measured data rows (75 on each side of the
	// merge, minus the K:Affinity:Affinity row main closed in 852ffe4f on top
	// of this branch's stack-option-kind closure).
	knownApproximationRows = 74
