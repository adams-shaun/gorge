...
const (
	...
	// approximation), 82d3ba68 deleted the (mtsp1) row (ability-activation
	// mana-spent riders), cli-20260923T060000Z-hlcz-imprint deleted the
	// hidden-library ChangeZone row (the GainControl$/ExileFaceDown$/
	// Imprint$ sub-shapes, closed by its two siblings and its own Imprint$
	// fix), and cli-20260923T060000Z-battle-defeated deleted the (battle1)
	// row (the CR 310.7 defender, the combat-damage defense-counter
	// removal, the CR 310.11 defeated exile-and-cast and the real protector
	// policy all landed).
