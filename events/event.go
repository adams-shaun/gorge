...
const (
	...
	// goading player; it is cleared when that player next begins a turn.
	Goad
...
var kindNames = [NumKinds]string{"game_start", "shuffle", "move_zone", "draw",
	...
	"delayed_register", "delayed_push", "library_order", "monarch_change", "control_change", "card_token", "keyword_trigger_push", "goad"}
