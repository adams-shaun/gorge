...
Measured at engine base `2d19918`, `.cards/cards.lock` commit
...
| prowess / Prowess | 2 | 45 | n/a | n/a | 31 T |
| prowess / Flashback | 4 | n/a | 22 | 22 | 22 C |
| prowess / Kicker | 1 | n/a | 0 | 0 | 0 C |

Prowess was already active (78 baseline triggers); this adds a second printed
...
- **Living Weapon and Prowess really trigger** (33 and 31); these are automatic
