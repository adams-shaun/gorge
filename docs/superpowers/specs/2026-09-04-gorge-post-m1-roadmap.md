...
| **M2r** | **Done**: ratchet to zero — every repo-deck card plays | `knownUnsupported` empty (0 of 136 deck cards); heads 2 `45e0671d07b60d9e`, 4 `795a100313094d6c`, 6 `0311852b655e44d0`, 8 `1216344ec91e5881`; `make report` 33,667 cards, 19,765 playable (58.7 %); `make sim` 20/20 replay OK; 42 `api:` + 31 `kw:` + 8 `stat:` + 8 `trig:` + 1 `repl:` = 90 primitives registered | Done — merged to `main` |
