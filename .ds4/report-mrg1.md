...
The following 77-line report is the sibling ticket `cli-20260922T225141Z-5641f97b`'s `mrg1` report, which on main replaced the file at this canonical path. Preserved verbatim per the archive convention; this ticket's own report history is above.
