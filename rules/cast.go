...
func (e *Engine) targetDependentCostMayPay(pc *pendingCast) bool {
	...
	return e.manaFeasibleGrant(pc.player, pc.resolvedMana(), mods, pc.taxGeneric, delve, pc.mayPlayIgnore)
}
...
func (e *Engine) affordableTargetCandidates(pc *pendingCast, candidates []targetCandidate) []targetCandidate {
	...
	for _, candidate := range candidates {
		...
		if e.manaFeasibleGrant(pc.player, pc.resolvedMana(), mods, pc.taxGeneric, delve, pc.mayPlayIgnore) ||
...
func (e *Engine) announceFeasible(pc *pendingCast, alt pipAlt, pool, snow state.Mana, life int32) bool {
	...
	return e.manaFeasibleGrant(pc.player, c, pc.mods, pc.taxGeneric, delve, pc.mayPlayIgnore)
}
