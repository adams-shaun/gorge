...
var apiSpecificRulesSA = map[string][]string{
	...
	// touches SA params), manaAbilityPayablePool's offer/payment path (the
	// pool-parameterized core manaAbilityPayable delegates to; the
	// potential-action walk calls it directly with the hypothetical bound),
	// the AvailableMana projection, and
