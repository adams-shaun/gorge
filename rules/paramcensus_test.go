...
var knownUnsupportedParams = map[string][]string{
	...
	"Dauthi Voidwalker":         {"param:api:Effect.ForgetOnMoved"},
	...
	"Goblin Guide":              {"param:api:Dig.LibraryPosition2", "param:api:Dig.Reveal"}, "Gravecrawler": {"param:stat:Continuous.IsPresent"},
