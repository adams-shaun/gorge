...
var knownUnsupportedParams = map[string][]string{
	...
	"Chandra, Awakened Inferno":   {"cost:SubCounter", "param:api:DealDamage.ReplaceDyingDefined", "param:api:Effect.Name"},
	...
	"Force of Will":               {"param:api:Counter.Destination"},
	"Forked Bolt":                 {"param:api:DealDamage.DividedAsYouChoose"},
	"Giada, Font of Hope":         {"param:api:PutCounter.ETB"},
	...
	"Jace, the Mind Sculptor":     {"param:api:ChangeZoneAll.Shuffle", "param:api:Dig.LibraryPosition2"},
	...
	"Vastewood Verge":             {"param:api:Mana.IsPresent"},
	...
	"Wrenn and Six":               {"param:api:Effect.Name", "param:api:Effect.Stackable"},
