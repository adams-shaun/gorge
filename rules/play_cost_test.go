...
func TestBeginPlayPayLifePlayCostSubstitutesTheManaValue(t *testing.T) {
	...
	e.beginPlay(0, bearID, false, "PayLife<ConvertedManaCost>")
	...
	e2.beginPlay(0, bear2, false, "PayLife<ConvertedManaCost>")
...
func TestPlayCostPricingAndHardDecline(t *testing.T) {
	...
	e.beginPlay(0, bearID, false, "SuspendCost")
	if e.cast != nil {
