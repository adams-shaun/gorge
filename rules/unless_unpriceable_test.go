...
func TestUnlessCostStrictParsePopulation(t *testing.T) {
	...
	want := []string{
		"A-Galvanic Discharge", "A-Karn, Living Legacy", "Academy Loremaster",
		"Aether Refinery", "Aether Spike", "Alliance of Arms", "Ancient Amphitheater",
		...
		"Development", "Die Young", "Dispelling Exhale", "Disruption Aura",
		...
		"Force Away", "Foreboding Ruins", "Fortified Village", "Frostboil Snarl",
		"Furycalm Snarl", "Galvanic Discharge", "Game Trail", "Gate to the Afterlife",
		"Gilt-Leaf Palace", "Glint Hawk", "Greenbelt Rampager", "Grip of Amnesia",
		...
		"Karoo", "Killing Wave", "Koskun Falls", "Kuroki, Thief of Talents",
		"Lathnu Hellion", "Lava Blister", "Liberty Prime, Recharged",
		...
		"Shakedown Heavy", "Shared Trauma", "Shineshadow Snarl", "Skullscorch",
		"Soul Strings", "Soul Tithe", "Spectral Denial", "Spell Rupture",
		"Spell Stutter", "Spell Syphon", "Static Prison", "Suppression Ray",
		"Swallowed by Leviathan", "Syncopate", "Taborax, Hope's Demise",
		"Tainted Specter", "Tariff", "Temporal Extortion", "Territorial Aetherkite",
		"Thassa's Intervention", "Thassa's Rebuff", "The Celestus",
		"The Legend of Yangchen", "The War Games", "Thelon's Chant",
		"Tibalt, Wicked Tormentor", "Tourach's Chant", "Tragic Lesson",
		"Transmute Artifact", "Treacherous Vampire", "Tresserhorn's Lord, Returned",
		"Treva's Ruins", "Trystan, Penitent Culler", "Tymaret Calls the Dead",
		...
		"Wheel of Potential", "Willie Lumpkin, Postman", "Worms of the Earth",
