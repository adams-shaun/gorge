...
func fixtures(t *testing.T) []Frame {
	...
	return []Frame{
		mk(THello, 0, Hello{Session: "s3", Tables: []TableInfo{{ID: "t1", Name: "Table 1", Seats: 4, Spectator: "omniscient", State: TableLive, Match: 7, Perpetual: true, Format: "commander", BotPolicy: "bot"}}}),
		...
		mk(TMatchStart, 0, MatchStart{Seats: []SeatInfo{{Name: "mono-red-goblins", Deck: "mono-red-goblins", Colour: SeatColours[0]}}, Seed: 12345, Spectator: "omniscient", BotPolicy: "bot"}),
