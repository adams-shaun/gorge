...
func TestDigPromptToSkipOptionalAbilityAsksForOptionalTake(t *testing.T) {
	h, ids := digAskFixture(t)
	saLine := "SP$ Dig | Defined$ You | DigNum$ 3 | ChangeNum$ 2 | PromptToSkipOptionalAbility$ True | ChangeValid$ Land | DestinationZone$ Hand | SkipReorder$ True"
